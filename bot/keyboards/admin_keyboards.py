...
def get_tickets_export_keyboard() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(text="📄 TXT", callback_data="export_tickets_txt"),
                InlineKeyboardButton(text="📊 CSV", callback_data="export_tickets_csv"),
            ],
            [InlineKeyboardButton(text="📗 Excel", callback_data="export_tickets_xlsx")],
        ]
    )
